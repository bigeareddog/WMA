...
describe "purchaseorder_items/new" do
  before(:each) do
    assign(:purchaseorder_item, stub_model(PurchaseorderItem,
      :po_no => "MyString",
      :po_item_no => "MyString",
      :status => "MyString",
  ...
  it "renders new purchaseorder_item form" do
    render

    # Run the generator again with the --webrat flag if you want to use webrat matchers
    assert_select "form", :action => purchaseorder_items_path, :method => "post" do
