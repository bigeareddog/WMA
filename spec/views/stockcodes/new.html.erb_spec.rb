...
describe "stockcodes/new" do
  before(:each) do
    assign(:stockcode, stub_model(Stockcode,
  ...
  it "renders new stockcode form" do
    render

    # Run the generator again with the --webrat flag if you want to use webrat matchers
    assert_select "form", :action => stockcodes_path, :method => "post" do
